...
use fruits_ffi::{FfiDroppable, FfiString, FfiTypedDroppable};
...
pub struct SystemsHolderBuilderFfi {
    data: FfiDroppable,
    vtable: FfiTypedDroppable<SystemsHolderBuilderFfiVTable>,
}
...
impl SystemsHolderBuilderFfi {
    pub fn new(types: TypesRegistryAccessFfi) -> Self {
        ...
        Self {
            ...
            vtable: FfiTypedDroppable::new(SystemsHolderBuilderFfiVTable {
