...
impl ArchetypeUnsafeFfi {
    pub fn new_from_components(components_set: UniqueComponentsSet) -> Self {
        Self {
            layout: ArchetypeLayout::from_components(components_set),
    ...
    pub unsafe fn add_component(src: &mut Self, dst: &mut Self, src_entity_index: u64, component_ptr: *mut u8, component_id: u64) -> Result<Entity, ()> {
    ...
    pub fn component_layout(&self, component_id: u64) -> Option<&ArchetypeItemLayout> {
        self.layout.get_component(component_id)
    }
