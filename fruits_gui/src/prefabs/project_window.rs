...
pub fn project_window(world: &mut WorldData) -> Entity {
    ...
    EntityComponentsBuilder::new(ec, ent_root)
    ...
    EntityComponentsBuilder::new(ec, ent_header)
        .add_component(GlobalRectComponent::default())
        .add_component(LocalRectComponent {
    ...
    EntityComponentsBuilder::new(ec, ent_scroll_content)
        .add_component(GlobalRectComponent::default())
        .add_component(LocalRectComponent {
