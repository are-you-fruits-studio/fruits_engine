...
fn serialize_impl(input: &DeriveInput) -> String {
    ...
    impl_serialize.push_str("fn serialize(&self, mut ctx: SerializerCtx) -> SerializedValue { ");
...
fn deserialize_impl(input: &DeriveInput) -> String {
    ...
    impl_deserialize.push_str("fn deserialize(mut ctx: SerializerCtx, value: &SerializedValue) -> Option<Self> { ");
